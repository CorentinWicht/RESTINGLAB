classdef headGrid % a grid used in Measure Projection
    ...
    methods
        function obj = headGrid(spacing, minGridLocation, maxGridLocation) % constructor
            ...
            % file for future use.
            % This part was modified for the plugin. 12/11/2018 Makoto.
            fullPath = which('nimasImagesfromMpA.m');
            folderPath = fullPath(1:end - length('nimasImagesfromMpA.m'));
            precomputedPath = [folderPath  'precomputed' filesep];
            
            filename = [precomputedPath 'inside_brain_information_for_headGrid_' num2str(obj.spacing) '_mm.mat'];
