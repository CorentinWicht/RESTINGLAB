...
%      ALLEEG - vector of lodaded EEG atasets
%
% Optional inputs:
...
function [STUDY, specdata, allfreqs, setinds, cinds] = std_readspec(STUDY, ALLEEG, varargin)
...
[STUDY, specdata, allfreqs, setinds, cinds] = std_readerp(STUDY, ALLEEG, 'datatype', 'spec', varargin{:});
