...
%
% EDITED BY :
% Corentin Wicht / corentin.wicht@unifr.ch (23.07.2019)
% Mod: Changed the interpolation algorithm from spherical splines to
% multiquadratics (i.e. better handles electrodes on the border of the cap)
...
signaltemp.data = EEGinterp('MQ',0.05,signaltemp,reindexedTargetChannels);
